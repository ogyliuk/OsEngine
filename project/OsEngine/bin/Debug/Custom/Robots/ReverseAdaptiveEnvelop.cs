...
[Bot("ReverseAdaptiveEnvelop")]
public class ReverseAdaptiveEnvelop : BotPanel
{
    ...
    private StrategyParameterDecimal Deviation;
    private StrategyParameterInt SmaBase;
    ...
    public ReverseAdaptiveEnvelop(string name, StartProgram startProgram)
        : base(name, startProgram)
    {
        ...
        AdxPeriod = CreateParameter("Adx Period", 10, 2, 300, 1, "Robot parameters");
        Ratio = CreateParameter("Ratio", 100, 50, 300, 10, "Robot parameters");
        Deviation = CreateParameter("Deviation", 0.5m, 0.5m, 3, 0.1m, "Robot parameters");
        SmaBase = CreateParameter("Sma Base", 10, 5, 50, 1, "Robot parameters");
        ...
        _APC = IndicatorsFactory.CreateIndicatorByName("AdaptiveEnvelop_Indicator", name + "APC", false);
